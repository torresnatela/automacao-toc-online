...
## Summary
- 2498 nodes · 4924 edges · 167 communities (142 shown, 25 thin omitted)
...
Cohesion: 0.10
Nodes (28): AtFixtureMode, AtFixtureState, DECLARACOES, fechar(), FORMULARIO_LOGIN(), gerarPdfSintetico(), html(), lerCookies() (+20 more)
...
Cohesion: 0.16
Nodes (10): ScanOutcome, ScanPayload, ScanRunnerDeps, CompanyScanner, CredentialSource, TocSessionFactory, build(), gridOf() (+2 more)

### Community 6 - "Fiscal Domain & RLS"
Cohesion: 0.20
Nodes (9): CompanyDirectory, UpsertReport, chunk(), DbCompanyDirectory, tocMetadata(), FakeDirectory, ExistingCompany, ReconcilePlan (+1 more)

### Community 7 - "Turborepo & Lint Config"
Cohesion: 0.05
Nodes (40): BrowserProvider, PlaywrightBrowser, PlaywrightBrowserOptions, InMemoryStorageStateStore, SavedSession, StorageState, StorageStateStore, AtFixtureServer (+32 more)
...
Cohesion: 0.10
Nodes (31): assertDocumentBelongsTo(), assertPdfIntegrity(), assertPeriodMatches(), assertAtHost(), AT, AtAuthError, AtAuthReason, AtIntegrityError (+23 more)
...
Cohesion: 0.13
Nodes (19): isPersistable(), normalizeScan(), persistableCompanies(), toCleanString(), toPositiveInt(), diff(), emptySummary(), planCompanyReconciliation() (+11 more)
...
Cohesion: 0.05
Nodes (36): CLAUDE.md — Automação de Guias Fiscais (TOConline), Comandos essenciais, Convenções técnicas, Estrutura, graphify, Mapa da documentação, Regras de trabalho, 10. Glossário (+28 more)

### Community 26 - "Worker Entrypoint"
Cohesion: 0.13
Nodes (5): IvaRunnerDeps, AtSessionFactory, ObligationLedger, PortalGate, Tracer
...
Cohesion: 0.06
Nodes (40): abortar(), abrirContexto(), Argumentos, escutar(), escutarPagina(), etapa(), hostDe(), irPara() (+32 more)
...
Cohesion: 0.06
Nodes (29): AtCompanyHandle, AtPrecondition, AttemptGuard, DeclarationRead, OpenedAtSession, PeriodState, traceDoDashboard(), AGORA (+21 more)
...
Cohesion: 0.31
Nodes (8): DocumentFieldWarning, CREDENTIAL_SCOPES, IvaDocumentJobResult, IvaFrequency, IvaResultKey, nonEmptyString(), parseIvaDocumentPayload(), ResultKeysCoverAll
...
Cohesion: 0.33
Nodes (7): digitsOnly(), documentFieldsComplete(), NormalizedDocumentFields, normalizeDocumentFields(), parseAmount(), presentText(), RawDocumentFields
...
Cohesion: 0.20
Nodes (15): fieldOf(), formatDatePt(), INVALID_REASON_LABELS, isDeferred(), IvaOutcomeRead, IvaOutcomeSpec, IvaSeverity, JobRowForOutcome (+7 more)
...
Cohesion: 0.16
Nodes (18): build(), comparePeriods(), match(), MONTH_BY_NAME, MONTH_NAME_PATTERNS, MONTH_NAMES_PT, MONTH_PATTERNS, monthPeriod() (+10 more)
...
Cohesion: 0.06
Nodes (43): deleteAtCredentialAction(), saveAtCredentialAction(), deleteTocCredentialAction(), saveTocCredentialAction(), ScanFormState, startCompanyScanAction(), ScanPanel(), ScanPanelProps (+35 more)
...
Cohesion: 0.17
Nodes (8): InMemoryStore, ErrorInput, EventStatus, LogLevel, StartTraceInput, TraceStatus, TriggerKind, UserEventInput
...
Cohesion: 0.22
Nodes (3): AtIvaDeclarationReader, AtOptions, IvaDeclarationReader

### Community 144 - "ObservabilityStore"
Cohesion: 0.16
Nodes (5): Logger, ObservabilityStore, createEvent(), EventHandle, EventInput
...
Cohesion: 0.19
Nodes (8): AuthenticatedTocSession, sleep(), countItems(), GridReadOptions, readCompaniesGrid(), projectGrid(), TocCompanyScanner, here
...
Cohesion: 0.18
Nodes (8): OpenedSession, TocOnlineCredentials, TOCONLINE, assertTocHost(), PlaywrightTocSessions, REJECTION_NOTICE, TocOnlineOptions, FakeSessions

### Community 158 - "GridProjection"
Cohesion: 0.17
Nodes (8): GridRead, assertScanIntegrity(), GridProjection, GridSource, FakeScanner, company(), scan(), CompanyScan
...
Cohesion: 0.18
Nodes (8): ActionMeta, getTracer(), motivoDaMarca(), db, equipasCriadas, queue, createDb(), schema
...
Cohesion: 0.17
Nodes (9): firstGroup(), parseFieldsFromText(), PATTERNS, AtPaymentDocumentFetcher, AuthenticatedAtSession, PaymentDocumentFetch, PaymentDocumentFetcher, RawPortalDocumentFields (+1 more)
...
## Knowledge Gaps
- **978 isolated node(s):** `Requisitos`, `1. Instalar e subir o Supabase local`, `2. Variáveis de ambiente — dois ficheiros, dois leitores`, `3. Aplicar migrations e seed`, `4. Subir o dashboard` (+973 more)
...
- **What connects `Requisitos`, `1. Instalar e subir o Supabase local`, `2. Variáveis de ambiente — dois ficheiros, dois leitores` to the rest of the system?**
