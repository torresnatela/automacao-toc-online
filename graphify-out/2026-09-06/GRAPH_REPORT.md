...
## Corpus Check
- 326 files · ~201,543 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2149 nodes · 4352 edges · 138 communities (109 shown, 29 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 17 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `84cb2811`
...
5. `AtCompanyHandle` - 26 edges
6. `getSupabaseAdminClient()` - 21 edges
7. `StructuralError` - 21 edges
8. `AcessoGovAtSessions` - 20 edges
9. `TocDirectAccessAtSessions` - 20 edges
10. `Módulo 1: Guia de Pagamento do IVA (TOConline → AT) — Design` - 17 edges
...
Cohesion: 0.06
Nodes (36): FakeAdmin, invalidRow, Row, CompanyRepo, CompanyServiceOutput, createCompany(), nn(), normalizeCompany() (+28 more)

### Community 1 - "Architecture & Domain Overview"
Cohesion: 0.05
Nodes (35): Acesso a dados, Auth / autorização, Banco de dados, Bootstrap do admin, Documentos e Storage (Módulo 1), Domínio (esqueleto, enums extensíveis), Fluxo de migrations, Multi-tenant (equipe = gabinete) (+27 more)
...
Cohesion: 0.16
Nodes (8): OpenedSession, build(), FakeSessions, gridOf(), rawRow(), traceDoDashboard(), InMemoryStore, createTracer()
...
Cohesion: 0.10
Nodes (17): AuthenticatedTocSession, CompanyScanner, countItems(), GridRead, GridReadOptions, readCompaniesGrid(), assertScanIntegrity(), GridProjection (+9 more)
...
Cohesion: 0.29
Nodes (9): TocDirectAccessOptions, TocOnlineCredentials, assertTocHost(), loginOnPage(), looksRejected(), REJECTION_NOTICE, submitLogin(), TocLoginOptions (+1 more)
...
Cohesion: 0.16
Nodes (24): capitalize(), dateFmt, formatDate(), TraceRow, TracesPage(), DataTable(), TableBody(), TableCell() (+16 more)

### Community 42 - "CLAUDE.md — Automação de Guias Fiscais (TOConline)"
Cohesion: 0.11
Nodes (18): allFields(), AtPageKind, AtPageSnapshot, classifyAtPage(), fingerprint(), hasNifField(), hasPasswordField(), hostOf() (+10 more)
...
Cohesion: 0.06
Nodes (47): deleteAtCredentialAction(), saveAtCredentialAction(), deleteTocCredentialAction(), saveTocCredentialAction(), ScanFormState, startCompanyScanAction(), CredentialFormState, Admin (+39 more)
...
Cohesion: 0.14
Nodes (25): Ctx, DELETE(), GET(), PATCH(), GET(), POST(), createTeamAction(), deleteTeamAction() (+17 more)

### Community 50 - "Portal automation (TOConline, AT, Segurança Social, e-Fatura)"
Cohesion: 0.31
Nodes (5): desfechoDoJob, markByOutcome(), RAZAO_POR_DESFECHO, AtCredentialSource, IvaDocumentJobPayload

### Community 51 - "@toc/worker RPA worker (scaffold)"
Cohesion: 0.10
Nodes (18): followDocument(), TOC_DIRECT_ACCESS, AcessoGovAtSessions, caminhosDe(), CaminhosDoPortal, FAMILIA_DE_LOGIN, SessaoAberta, SessaoToc (+10 more)
...
Cohesion: 0.25
Nodes (10): DocumentFieldWarning, AT_ACCESS_MODES, CREDENTIAL_SCOPES, IvaDocumentJobResult, IvaFrequency, IvaResultKey, nonEmptyString(), parseIvaDocumentPayload() (+2 more)
...
### Community 63 - "CompanyForm.tsx"
Cohesion: 0.31
Nodes (7): CompanyForm(), TeamForm(), Textarea(), COMPANY_STATUS_LABELS, CONTRIBUTOR_TYPE_LABELS, labelOf(), TEAM_STATUS_LABELS
...
Cohesion: 0.29
Nodes (6): CookieToSet, updateSession(), config, proxy(), ChangePasswordGuardInput, shouldRedirectToChangePassword()
...
Cohesion: 0.14
Nodes (22): initialState, TeamFormProps, AuthLayout(), AuthLayoutProps, CredentialForm(), CredentialFormCopy, CredentialFormProps, formatDate() (+14 more)

### Community 72 - "RowDetailsDialog.tsx"
Cohesion: 0.38
Nodes (6): FetchAllState, FetchAllButton(), FetchAllButtonProps, BulkPlanSummary, BULK_COPY, formatNotReadyReasons()

### Community 73 - "StartedAction"
Cohesion: 0.19
Nodes (18): GET(), naoEncontrado(), changePassword(), ChangePasswordPage(), DashboardLayout(), LogsPage(), TraceRow, signIn() (+10 more)

### Community 74 - "credential-form.tsx"
Cohesion: 0.05
Nodes (30): ContextoDoJob, IvaRunnerDeps, IvaRunnerPolicy, AttemptGuard, DeclarationRead, IvaDeclarationReader, ObligationLedger, PaymentDocumentFetch (+22 more)
...
Cohesion: 0.15
Nodes (6): backoffMs(), JobQueue, DbAttemptGuard, DbCredentialSource, motivoDaMarca(), Database

### Community 80 - "clients (empresas do gabinete)"
Cohesion: 0.11
Nodes (23): ProfileRow, generateTempPassword(), AssignRoleResult, CreateAuthUserResult, registerUser(), RegisterUserDeps, RegisterUserInput, RegisterUserOutput (+15 more)
...
Cohesion: 0.05
Nodes (49): abortar(), abrirContexto(), Argumentos, escutar(), escutarPagina(), etapa(), EXTENSAO_POR_OMISSAO, hostDe() (+41 more)
...
### Community 88 - "cn"
Cohesion: 0.09
Nodes (29): AppShellProps, NAV_ITEMS, NavItem, SidebarContent(), ROLE_LABELS, UserMenu(), Logo(), LogoProps (+21 more)
...
Cohesion: 0.40
Nodes (5): IntegracoesPage(), Integration, INTEGRATIONS, PageProps, getTeamCredential()

### Community 93 - "parse-fields.ts"
Cohesion: 0.47
Nodes (4): firstGroup(), parseFieldsFromText(), PATTERNS, RawPortalDocumentFields

### Community 94 - "browser.ts"
Cohesion: 0.11
Nodes (39): BatchProgress(), GuiasIvaPage(), PageProps, summarizeBulkPlan(), ACCESS_LABEL, ACCESS_TARGET, accessHint(), batchProgress() (+31 more)
...
Cohesion: 0.24
Nodes (12): fetchAllIvaDocumentsAction(), fetchIvaDocumentAction(), FetchState, FetchButton(), FetchButtonProps, RowDetailsDialog(), RowDetailsDialogProps, accessFromForm() (+4 more)
...
Cohesion: 0.18
Nodes (13): ClassifiedFailure, IvaOutcome, BulkRow, calendarMonth(), CONCLUSIVE_OUTCOMES, ivaFetchReadiness(), IvaNotReadyReason, IvaReadiness (+5 more)
...
Cohesion: 0.15
Nodes (8): db, doc(), equipasCriadas, ficheirosCriados, KEY, makeCompany(), nextNif(), pool

### Community 117 - "WorkerLoop"
Cohesion: 0.12
Nodes (7): ClaimedJob, JobHandler, JobOutcome, WorkerLoop, WorkerLoopDeps, sleep(), FakeQueue
...
Cohesion: 0.16
Nodes (19): build(), comparePeriods(), formatPeriodPt(), match(), MONTH_BY_NAME, MONTH_NAME_PATTERNS, MONTH_NAMES_PT, MONTH_PATTERNS (+11 more)

### Community 122 - "Task 2 Report: Buckets de Storage (`guias` e `rpa-diagnostics`)"
Cohesion: 0.05
Nodes (43): ActionMeta, getTracer(), StartedAction, createDb(), profiles, companies, documents, integrationCredentials (+35 more)
...
Cohesion: 0.22
Nodes (12): makeCredential(), decryptSecret(), encryptSecret(), generateEncryptionKey(), isEncryptedSecret(), MESSAGES, ParsedToken, parseToken() (+4 more)

### Community 129 - "page.tsx"
Cohesion: 0.10
Nodes (36): buildBulkRows(), BulkCompany, BulkCounts, BulkPlan, bulkRowsFromReads(), BulkRowsResult, companyForEnqueue(), credentialForReadiness() (+28 more)

### Community 135 - "auth-profiles.smoke.test.ts"
Cohesion: 0.33
Nodes (3): db, equipasCriadas, queue

### Community 144 - "ObservabilityStore"
Cohesion: 0.12
Nodes (13): Logger, ObservabilityStore, createEvent(), EventHandle, Tracer, ErrorInput, EventInput, EventStatus (+5 more)
...
Cohesion: 0.08
Nodes (31): assertDocumentBelongsTo(), assertPdfIntegrity(), assertPeriodMatches(), assertSessionBelongsTo(), cellAt(), COLUMN_KEYWORDS, DeclarationRow, findColumn() (+23 more)

### Community 151 - "Logger"
Cohesion: 0.16
Nodes (8): parsePayload(), ScanOutcome, ScanPayload, ScanRunnerDeps, CredentialSource, TocSessionFactory, ScanJobResult, observability

### Community 154 - "page.tsx"
Cohesion: 0.18
Nodes (18): AdminUsersPage(), EditCompanyPage(), EmpresasPage(), EquipesPage(), PageProps, RESULT_LABELS, TocOnlinePage(), ScanPanel() (+10 more)

### Community 167 - "sinks.test.ts"
Cohesion: 0.28
Nodes (8): db, equipasCriadas, KEY, makeCredential(), makeTeam(), nextNif(), pool, scanned()

## Knowledge Gaps
- **644 isolated node(s):** `admin`, `PageProps`, `PageProps`, `LastFetch`, `BulkPlan` (+639 more)
...
- **Why does `AppShell()` connect `Web App Dependencies` to `cn`, `StartedAction`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **What connects `admin`, `PageProps`, `PageProps` to the rest of the system?**
