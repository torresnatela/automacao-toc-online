...
## Corpus Check
- 235 files · ~100,129 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1398 nodes · 2606 edges · 149 communities (75 shown, 74 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 10 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `94e5efeb`
...
Cohesion: 0.12
Nodes (19): DbCredentialSource, db, KEY, makeCredential(), makeTeam(), nextNif(), pool, scanned() (+11 more)
...
Cohesion: 0.14
Nodes (26): Ctx, DELETE(), PATCH(), GET(), POST(), CompanyFormState, createCompanyAction(), deleteCompanyAction() (+18 more)
...
Cohesion: 0.18
Nodes (9): PlaywrightBrowser, loadEnv(), MissingEnvError, parseRpaConcurrency(), REQUIRED, WorkerEnv, log(), main() (+1 more)
...
Cohesion: 0.08
Nodes (28): ProfileRow, CookieToSet, updateSession(), config, proxy(), ChangePasswordGuardInput, shouldRedirectToChangePassword(), generateTempPassword() (+20 more)
...
### Community 88 - "cn"
Cohesion: 0.11
Nodes (24): ROLE_LABELS, UserMenu(), WaveMotif(), WaveMotifProps, EmptyStateProps, AlertTitle(), Avatar(), initialsFrom() (+16 more)
...
Cohesion: 0.29
Nodes (4): AuthenticatedTocSession, OpenedSession, TocOnlineCredentials, PlaywrightTocSessions

### Community 116 - "GridProjection"
Cohesion: 0.13
Nodes (12): CompanyScanner, countItems(), GridRead, GridReadOptions, readCompaniesGrid(), GridProjection, GridSource, projectGrid() (+4 more)

### Community 117 - "company-scan-runner.test.ts"
Cohesion: 0.10
Nodes (14): ScanOutcome, ScanPayload, ScanRunnerDeps, CredentialLookup, CredentialSource, TocSessionFactory, build(), FakeCredentials (+6 more)

### Community 118 - "storage-state.ts"
Cohesion: 0.09
Nodes (17): BrowserProvider, PlaywrightBrowserOptions, InvalidCredentialsError, StructuralError, assertTocHost(), REJECTION_NOTICE, TocOnlineOptions, InMemoryStorageStateStore (+9 more)
...
Cohesion: 0.13
Nodes (23): CredentialFormState, deleteTocCredentialAction(), saveTocCredentialAction(), ScanFormState, startCompanyScanAction(), JOB_LABELS, JOB_TONES, PageProps (+15 more)
...
Cohesion: 0.18
Nodes (13): getWebTracer(), logUserEvent(), traceDoDashboard(), createTracer(), Tracer, ErrorInput, EventStatus, LogLevel (+5 more)
...
Cohesion: 0.18
Nodes (14): ChangePasswordPage(), DashboardLayout(), LogsPage(), TraceRow, EventRow, LogRow, renderEventTree(), TraceDetailPage() (+6 more)
...
Cohesion: 0.19
Nodes (21): CompanyForm(), TeamForm(), capitalize(), dateFmt, formatDate(), TraceRow, TracesPage(), DataTable() (+13 more)

### Community 139 - "CompanyForm.tsx"
Cohesion: 0.22
Nodes (15): initialState, TeamFormState, TeamFormProps, ScanPanelProps, AuthLayout(), FormField(), FormFieldProps, Alert() (+7 more)

### Community 140 - "service.ts"
Cohesion: 0.14
Nodes (20): changePassword(), createUser(), CreateUserState, VALID_UI_ROLES, CreateUserForm(), Admin, cipher, CredentialMutationResult (+12 more)

### Community 141 - "Database"
Cohesion: 0.14
Nodes (10): ActionMeta, getTracer(), StartedAction, backoffMs(), JobQueue, db, queue, createDb() (+2 more)

### Community 142 - "ClaimedJob"
Cohesion: 0.14
...
### Community 145 - "requireRole"
Cohesion: 0.35
Nodes (10): GET(), AdminUsersPage(), EditCompanyPage(), EmpresasPage(), EquipesPage(), TocOnlinePage(), buttonVariants, requireRole() (+2 more)

### Community 146 - "sidebar.tsx"
Cohesion: 0.24
Nodes (6): AppShellProps, NAV_ITEMS, NavItem, SidebarContent(), Logo(), LogoProps

### Community 147 - "status-badge.tsx"
Cohesion: 0.31
Nodes (7): StatusBadgeProps, StatusKind, Tone, TONES, Badge(), BadgeProps, badgeVariants
...
- **Why does `AppShell()` connect `Web App Dependencies` to `sidebar.tsx`, `InMemoryStore`?**
